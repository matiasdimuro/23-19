...
public class PantallaServidorDesconectado extends Pantalla {
	...
	public void show() {
		super.show();
		fondo = new Imagen("backgrounds/servidor-desconectado.jpeg", 0, 0, ConfigGraficos.ANCHO_PANTALLA, ConfigGraficos.ALTO_PANTALLA);
