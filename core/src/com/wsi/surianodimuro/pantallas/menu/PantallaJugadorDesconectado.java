...
public class PantallaJugadorDesconectado extends Pantalla {
	...
	public void show() {
		super.show();
		fondo = new Imagen("backgrounds/agente-desconectado.jpeg", 0, 0, ConfigGraficos.ANCHO_PANTALLA, ConfigGraficos.ALTO_PANTALLA);
