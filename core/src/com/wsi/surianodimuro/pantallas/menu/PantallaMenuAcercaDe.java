...
public class PantallaMenuAcercaDe extends Pantalla {
	...
	public void show() {
		super.show();
		fondo = new Imagen("backgrounds/AcercaDe.png", 0, 0, ConfigGraficos.ANCHO_PANTALLA, ConfigGraficos.ALTO_PANTALLA);
