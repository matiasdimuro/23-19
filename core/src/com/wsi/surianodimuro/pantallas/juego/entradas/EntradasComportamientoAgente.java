	...
	public void procesarEntrada() {
		...
		if (!((Gdx.input.isKeyPressed(Keys.LEFT)) && (Gdx.input.isKeyPressed(Keys.RIGHT)))) {
			...
			if (Gdx.input.isKeyPressed(Keys.LEFT)) {
				...
				if (Globales.movimientoAgenteListener.chequearColisiones()) { Globales.jugadores.get(numAgente).moverseDerecha(); }
				...
				if (Globales.movimientoAgenteListener.chequearColisiones()) { Globales.jugadores.get(numAgente).moverseIzquierda(); }
		...
		if (!((Gdx.input.isKeyPressed(Keys.UP)) && (Gdx.input.isKeyPressed(Keys.DOWN)))) {
			...
			if ((Globales.jugadores.get(numAgente).controlador.arriba) || (Globales.jugadores.get(numAgente).controlador.abajo)) {
